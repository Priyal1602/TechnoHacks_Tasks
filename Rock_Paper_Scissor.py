# -*- coding: utf-8 -*-
"""
Created on Tue Jun 13 15:12:30 2023
...
b1= Button(labelframe, text= "Rock", font= 10, width= 7, command= isrock, bg="lightblue")
b1.place(relx=.25, rely= .62)
b2= Button(labelframe, text= "Paper", font= 10, width= 7 ,command= ispaper, bg="lightblue")
b2.place(relx= .41,rely= .62)
b3= Button(labelframe, text= "Scissor", font= 10, width= 7, command= isscissor, bg="lightblue")
